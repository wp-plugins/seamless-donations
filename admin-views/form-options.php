...
class Dgx_Donate_Admin_Form_Options_View {
	...
	function __construct() {
		...
		$this->form_options = array(
			array(
				'prompt' => __( 'Designated Funds Checkbox and Section', 'dgx-donate' ),
				'key' => 'dgx_donate_show_designated_funds_section',
				'default' => 'true',
				'show_require_option' => false
			),
			array(
				'prompt' => __( 'Repeating Donation Checkbox', 'dgx-donate' ),
				'key' => 'dgx_donate_show_repeating_option',
				'default' => 'true',
				'show_require_option' => false
			),
			array(
				'prompt' => __( 'Tribute Gift Checkbox and Section', 'dgx-donate' ),
				'key' => 'dgx_donate_show_tribute_section',
				'default' => 'true',
				'show_require_option' => false
			),
			array(
				'prompt' => __( 'Employer Match Section', 'dgx-donate' ),
				'key' => 'dgx_donate_show_employer_section', /* just the match option checkbox */
				'default' => 'true',
				'show_require_option' => false
			),
			array(
				'prompt' => __( 'Donor Telephone Field', 'dgx-donate' ),
				'key' => 'dgx_donate_show_donor_telephone_field',
				'default' => 'true',
				'show_require_option' => true
			),
			array(
				'prompt' => __( 'Donor Employer Field', 'dgx-donate' ),
			...
			array(
				'prompt' => __( 'Anonymous Donation Checkbox', 'dgx-donate' ),
				'key' => 'dgx_donate_show_anonymous_option',
				'default' => 'true',
				'show_require_option' => false
			),
			array(
				'prompt' => __( 'Donor Address Section', 'dgx-donate' ),
